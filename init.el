...
(doom! :input
       ...
       (json +lsp
             +treesitter)  ; At least it ain't XML
       ...
       ;;(lua +lsp)        ; FIXME one-based indices? one-based indices
       ;;     +moonscript) ; in the name of the Moon, I'll punish you!
       ...
       ;;twitter           ; RIP 3rd party twitter clients
